...
mkdir inteldaal.redist.linux-x64.%VER%\runtimes\linux-x64\native
mkdir inteldaal.redist.linux-x86.%VER%
mkdir inteldaal.redist.linux-x86.%VER%\runtimes               
mkdir inteldaal.redist.linux-x86.%VER%\runtimes\linux-x86       
mkdir inteldaal.redist.linux-x86.%VER%\runtimes\linux-x86\native
...
xcopy /S /Y /Q __release_lnx\daal\lib\ia32_lin\*.so     inteldaal.redist.linux-x86.%VER%\runtimes\linux-x86\native\
...
xcopy /Y /Q ..\documentation\en\common\license.txt inteldaal.redist.linux-x86.%VER%\
...
xcopy /Y /Q bin\nuget\inteldaal.redist.linux-x86.nuspec inteldaal.redist.linux-x86.%VER%\
