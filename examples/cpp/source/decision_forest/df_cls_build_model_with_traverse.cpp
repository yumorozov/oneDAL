/* file: df_cls_build_model_with_traverse.cpp */
/*******************************************************************************
...
/**
 * <a name="DAAL-EXAMPLE-CPP-DF_CLS_BUILD_MODEL_WITH_TRAVERSE"></a>
 * \example df_cls_build_model_with_traverse.cpp
 */
...
int main(int argc, char *argv[])
{
    ...
    {
        std::cout << "Model was built successfuly" << std::endl;
        return 0;
    }
    else
    {
