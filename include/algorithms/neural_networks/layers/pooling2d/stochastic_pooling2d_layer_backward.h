...
public:
    ...
    typedef algorithms::neural_networks::layers::stochastic_pooling2d::backward::Input     InputType;
    typedef algorithms::neural_networks::layers::stochastic_pooling2d::Parameter           ParameterType;
    typedef algorithms::neural_networks::layers::stochastic_pooling2d::backward::Result    ResultType;

    ParameterType &parameter; /*!< Backward stochastic 2D pooling layer \ref interface1::Parameter "parameters" */
    InputType input;          /*!< Backward stochastic 2D pooling layer input */
