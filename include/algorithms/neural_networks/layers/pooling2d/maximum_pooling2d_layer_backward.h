...
public:
    ...
    typedef algorithms::neural_networks::layers::maximum_pooling2d::backward::Input     InputType;
    typedef algorithms::neural_networks::layers::maximum_pooling2d::Parameter           ParameterType;
    typedef algorithms::neural_networks::layers::maximum_pooling2d::backward::Result    ResultType;

    ParameterType &parameter; /*!< Backward maximum 2D pooling layer \ref interface1::Parameter "parameters" */
    InputType input;          /*!< Backward maximum 2D pooling layer input */
