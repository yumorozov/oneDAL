...
public:
    ...
    typedef algorithms::neural_networks::layers::lrn::forward::Input     InputType;
    typedef algorithms::neural_networks::layers::lrn::Parameter          ParameterType;
    typedef algorithms::neural_networks::layers::lrn::forward::Result    ResultType;

    ParameterType &parameter; /*!< Forward local response normalization layer \ref interface1::Parameter "parameters" */
    InputType input;          /*!< Forward local response normalization layer input */
