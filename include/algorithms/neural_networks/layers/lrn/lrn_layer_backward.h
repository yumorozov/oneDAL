...
public:
    ...
    typedef algorithms::neural_networks::layers::lrn::backward::Input     InputType;
    typedef algorithms::neural_networks::layers::lrn::Parameter           ParameterType;
    typedef algorithms::neural_networks::layers::lrn::backward::Result    ResultType;

    ParameterType &parameter; /*!< Backward local response normalization layer \ref interface1::Parameter "parameters" */
    InputType input;          /*!< Backward local response normalization layer input */
