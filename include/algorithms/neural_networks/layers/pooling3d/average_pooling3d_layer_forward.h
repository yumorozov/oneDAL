...
public:
    ...
    typedef algorithms::neural_networks::layers::average_pooling3d::forward::Input     InputType;
    typedef algorithms::neural_networks::layers::average_pooling3d::Parameter          ParameterType;
    typedef algorithms::neural_networks::layers::average_pooling3d::forward::Result    ResultType;

    ParameterType &parameter; /*!< Forward average 3D pooling layer \ref interface1::Parameter "parameters" */
    InputType input;          /*!< Forward average 3D pooling layer input */
