...
public:
    ...
    typedef algorithms::neural_networks::layers::spatial_average_pooling2d::backward::Input  InputType;
    typedef algorithms::neural_networks::layers::spatial_average_pooling2d::Parameter        ParameterType;
    typedef algorithms::neural_networks::layers::spatial_average_pooling2d::backward::Result ResultType;

    ParameterType &parameter; /*!< Backward spatial pyramid average 2D pooling layer \ref interface1::Parameter "parameters" */
    InputType input;          /*!< Backward spatial pyramid average 2D pooling layer input */
