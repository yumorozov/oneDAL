...
public:
    ...
    typedef algorithms::neural_networks::layers::dropout::forward::Input     InputType;
    typedef algorithms::neural_networks::layers::dropout::Parameter          ParameterType;
    typedef algorithms::neural_networks::layers::dropout::forward::Result    ResultType;

    ParameterType &parameter; /*!< Forward dropout layer \ref interface1::Parameter "parameters" */
    InputType input;          /*!< Forward dropout layer input */
