...
{
    __DAAL_INITIALIZE_KERNELS(internal::PCASVDBatchKernel, interface3::BatchParameter
                       <algorithmFPType, pca::svdDense>, algorithmFPType);
}
...
Status BatchContainer<algorithmFPType, svdDense, cpu>::compute()
{
    ...
    interface3::BatchParameter<algorithmFPType, pca::svdDense>* parameter = static_cast<interface3::BatchParameter<algorithmFPType,
                                                                                        pca::svdDense> *>(_par);
    ...
    __DAAL_CALL_KERNEL(env, internal::PCASVDBatchKernel, __DAAL_KERNEL_ARGUMENTS(algorithmFPType, interface3::BatchParameter
