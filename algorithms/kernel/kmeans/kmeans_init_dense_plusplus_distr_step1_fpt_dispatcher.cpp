/* file: kmeans_init_dense_plusplus_distr_step1_fpt_dispatcher.cpp */
/*******************************************************************************
...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::init::DistributedContainer, distributed, step1Local,  DAAL_FPTYPE, kmeans::init::plusPlusDense)
}
...
using DistributedType = Distributed<step1Local, DAAL_FPTYPE, kmeans::init::plusPlusDense>;
