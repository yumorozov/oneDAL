/* file: kmeans_init_csr_parallelplus_distr_step3_fpt_dispatcher.cpp */
/*******************************************************************************
...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::init::DistributedContainer, distributed, step3Master,  DAAL_FPTYPE, kmeans::init::parallelPlusCSR)
}
...
using DistributedType = Distributed<step3Master, DAAL_FPTYPE, kmeans::init::parallelPlusCSR>;
