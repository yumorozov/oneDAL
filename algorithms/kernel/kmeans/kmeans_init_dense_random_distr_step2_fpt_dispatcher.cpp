...
{
__DAAL_INSTANTIATE_DISPATCH_CONTAINER(kmeans::init::DistributedContainer, distributed, step2Master, DAAL_FPTYPE, kmeans::init::randomDense)
}
    ...
    parameter(*static_cast<ParameterType*>(_par))
{
    Analysis<distributed>::_ac = new __DAAL_ALGORITHM_CONTAINER(distributed, DistributedContainer, step2Master,
        DAAL_FPTYPE, kmeans::init::randomDense)(&_env);
    _in  = &input;
}
