...
public:
    ...
    */
    Status updateArgument(size_t iIteration, size_t t, size_t epoch, size_t m, size_t correctionIndex, size_t nTerms,
        size_t batchSize, algorithmFPType accuracyThreshold,
        sum_of_functions::BatchPtr &gradientFunction,
        NumericTablePtr &ntGradient, NumericTablePtr &ntValue, algorithmFPType *argument, bool& bContinue,
    ...
    */
    Status updateCorrectionPairBatchIndices(size_t iPredefinedIndicesRow, size_t nTerms, size_t batchSize, daal::algorithms::engines::internal::BatchBaseImpl* engine)
    {
        return updateBatchIndices(iPredefinedIndicesRow, nTerms, batchSize, correctionPairBatchIndices,
            correctionPairBatchIndicesStatus, mtCorrectionPairBatchIndices, ntCorrectionPairBatchIndices, engine);
    }
...
private:
    ...
    * or Hessian matrix computations
    */
    Status updateBatchIndices(size_t iPredefinedIndicesRow, size_t nTerms, size_t batchSize, int*& batchIndices,
